  ...
  return (
    <Card className="w-full max-w-lg">
      <CardHeader>
        ...
        <CardDescription>
          Add an audio recording or paste raw text notes for a new interview.
        </CardDescription>
      </CardHeader>
      <Form {...form}>
          ...
          <CardContent className="flex flex-col gap-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. Candidate A - Round 1" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            {uploadMutation.isSuccess && (
              <p className="text-sm text-emerald-600">
                Interview &quot;{uploadMutation.data.title}&quot; uploaded
                successfully.
              </p>
            )}
          </CardContent>
